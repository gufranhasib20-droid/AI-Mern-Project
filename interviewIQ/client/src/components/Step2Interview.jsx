...
useEffect(() => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-100 flex items-center justify-center p-4">
            ...
            <div className="w-full max-w-5xl h-[560px] bg-white rounded-3xl shadow-2xl border border-gray-200 flex overflow-hidden">

                <div className="w-[35%] bg-white flex flex-col items-center p-5 border-r border-gray-200">
...
<div className='text-base sm:text-lg font-semibold text-gray-800
   ...
   {!feedback ? ( <div className='flex items-center gap-4 mt-6'>
        ...
        initial={{opacity:0}}
        animate={{opacity:1}}
        className="mt-6 bg-emrald-50 border border-emerald-200 p-5 rounded-2xl shadow-sm">
            <p className="text-emerald-700 font-medium mb-4">{feedback}</p>

             <button
             onClick={handleNext} 
             className="w-full bg-gradient-to-r from-emerald-600 to-teal-500 text-white py-3 rounded-xl shadow-md hover:opacity-90 transition flex items-center justify-center gap-1">Next Question <BsArrowRight size={18}/></button>
