...
import confidenceImg from '../assets/config.png';
                ...
                <div className='text-center mb-28'>
                    ...
                    <div className='flex flex-wrap justify-center gap-4 mt-10' >
                        <motion.button
                         ...
                         className="bg-black text-white px-10 py-3 rounded-xl hover:opacity-90 transition shadow-md">
                            Start Interview
                            </motion.button>
                        <motion.button
                         onClick={() => {
                    ...
                    <div className="grid md:grid-cols-2 gap-10">
                        {[
                            ...
                            },
                            {
                                ...
                                desc:"Deep technical questioning based on selectiong role."
                            },
                            {
                                img:confidenceImg,
                            ...
                            },
                            {
                                ...
                                desc:"Unlock premium interview sessions esily"
